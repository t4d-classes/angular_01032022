...
const routes: Routes = [
  ...
  {
    path: 'categories',
    loadChildren: () => import('./category-tool/category-tool.module').then(m => m.CategoryToolModule),
  },
  {
    path: 'employees',
    loadChildren: () => import('./employee-tool/employee-tool.module').then(m => m.EmployeeToolModule),
  },
