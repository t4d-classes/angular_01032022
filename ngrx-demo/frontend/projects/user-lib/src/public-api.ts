...
export * from './lib/reducers/currentUser.reducer';
export * from './lib/selectors/currentUser.selector';
export * from './lib/effects/currentUser.effects';
...
export * from './lib/user-lib.state';
